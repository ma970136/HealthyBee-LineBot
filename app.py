...
def handle_message(event):
    ...
    # ✅ 選擇語言
    if msg == "选择语言" or msg == "選擇語言" or msg == "Choose Language" or msg == "言語選択":
        reply_text = "🌐 請選擇語言："
    ...
    # ✅ 查步數指令
    if "每日步数" in msg or "每日步數" in msg or "Daily Steps" in msg or "日々の歩数" in msg:
        thingspeak_url = f"https://api.thingspeak.com/channels/{THINGSPEAK_CHANNEL_ID}/fields/2.json?results=1000"
    ...
    # ✅ 查心率指令
    if "查询心率" in msg or "查詢心率" in msg or "Get Heart Rate Data" in msg or "心拍数の確認" in msg:
